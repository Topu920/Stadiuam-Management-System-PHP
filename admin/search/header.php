                  ...
                  <ul class="nav nav-pills navbar-inverse navbar-right">
                     ...
                     <!--search area start-->
                      ...
                      <a href="" class="dropdown-toggle" data-toggle="dropdown">Delete<span class="caret"></span></a>
                          <ul class="dropdown-menu">
                          <li><a href="../delete/gam_sch_del.php">Game Schedule</a></li>
                          <li class="divider"></li>
                          <li><a href="../delete/audience_del.php">Audince</a></li>
                          <li class="divider"></li>
                          <li><a href="../delete/emply_del.php">Employee</a></li>
                          <li class="divider"></li>
                          <li><a href="../delete/vend_del.php">Vendor</a></li>
                          <li class="divider"></li>
                          <li><a href="../delete/medic_del.php">Medic</a></li>
                          <li class="divider"></li>
                          <li><a href="../delete/gal_del.php">Gallery</a></li>
                          <li class="divider"></li>
                          <li><a href="../delete/accounts_del.php">Accounts</a></li>
